    ...
    <div class="content">
        ...
        <div class="page-inner mt--5">
            <div class="card shadow p-3">
                ...
                <form action="<?= base_url('user/aksi_insert_pemeriksaan') ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_dokter" name="id_dokter">
                            ...
                            <?php foreach ($dokter as $d) : ?>
                                <option value="<?= $d['id']; ?>"><?= $d['id'] . '-' . $d['nama_dokter'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="anamnese_pemeriksaan_diagnosis" name="anamnese_pemeriksaan_diagnosis" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">rencana_pelayanan_dan_therapi</label>
                        <input type="text" class="form-control" id="rencana_pelayanan_dan_therapi" name="rencana_pelayanan_dan_therapi" required>
                    </div>
                    <div class="form-group">
