        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                ...
                <a href="index.html" class="logo">
                    <img src="<?= base_url() ?>/assets/img/logoku.png" alt="navbar brand" width="50" class="navbar-brand"><span class="text-white" style="font-size: small; font-weight: 700;">Puskesmas Patuk II</span>
                </a>
